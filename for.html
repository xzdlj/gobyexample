...
<html>
  <head>
    <meta charset="utf-8">
    <title>Go by Example 中文版: For 循环</title>
  ...
  <body>
    ...
    <div class="example" id="for">
      <h2><a href="./">Go by Example 中文版</a>: For 循环</h2>
      
      <table>
        
        <tr>
          <td class="docs">
            <p><code>for</code> 是 Go 中唯一的循环结构。这里会展示 <code>for</code> 循环的一些基本使用方式。</p>
        ...
        <tr>
          ...
          <td class="code leading">
            <a href="https://play.studygolang.com/p/fZwdQvZgIqu"><img title="Run code" src="play.png" class="run" /></a><img title="Copy code" src="clipboard.png" class="copy" />
        ...
        <tr>
          <td class="docs">
            <p>经典的初始/条件/后续 <code>for</code> 循环。</p>
        ...
        <tr>
          <td class="docs">
            <p>不带条件的 <code>for</code> 循环将一直重复执行，
直到在循环体内使用了 <code>break</code> 或者 <code>return</code> 跳出循环。</p>
        ...
        <tr>
          <td class="docs">
            <p>你也可以使用 <code>continue</code> 直接进入下一次循环。</p>
      ...
      <table>
        ...
        <tr>
          <td class="docs">
            <p>我们在后续教程中学习 <code>range</code> 语句，channels 以及其他数据结构时，
还会看到一些 <code>for</code> 的其它用法。</p>
      ...
      <p class="next">
        下一个例子: <a href="if-else">If/Else 分支</a>
      </p>
